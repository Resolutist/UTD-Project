//This program calculates factorials using loop and recursive techniques.
//CS 1337 Assignment 6
//11/25/20
//By: Kyle White
#include <chrono>
#include <limits>
...
int main()
{
    ...
    /*Creating objects for each calculation class, and then passing the
    arguments to the following constructors.*/
    FactorialCalculationClass <uint16_t> factorialCalculateUint160bj(16);
    FactorialCalculationClass <uint32_t> factorialCalculateUint320bj(32);
    FactorialCalculationClass <uint64_t> factorialCalculateUint640bj(64);

    factorialCalculateUint160bj.executeFactorialForType();
    factorialCalculateUint320bj.executeFactorialForType();
    factorialCalculateUint640bj.executeFactorialForType();
